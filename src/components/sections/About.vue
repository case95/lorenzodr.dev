        ...
        <div class="about-content">
            <div class="bio">
                ...
                <div class="skillset">
                    <p class="skillset-introduction">
                        My skillset is composed by:<br><br>
                    </p>
                    <div class="skillset-tables">
                         <table>
                             <thead>
                                 <tr>
                                    <th>Development</th>
            ...
            <div class="portrait">
                <div class="portrait-inner">
                    <img src="/img/about/profile.png" alt="portrait" class="portrait-image">
                </div>
            </div>
        ...
        #{&}-content{
                ...
                .skillset{
                    ...
                    &-tables {
                        ...
                        table{
                            ...
                            &:nth-child(1){
                                padding: 0 0 10px 0;
                                border-bottom: $my-white 1px solid;
                            }
                            &:nth-child(2){
                                padding:10px 0 0 0;
                            }
            ...
            .portrait {
                ...
                &-image {
                    ...
                    width: 100%;
                    height: 100%;
                    @include transition-experience(filter);
                    ...
                    .skillset-tables {
                        ...
                        table{
                            ...
                            &:nth-child(1){
                                ...
                                border-right: $my-white 1px solid;
                            }
                            &:nth-child(2){
