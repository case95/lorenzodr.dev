  ...
  <div class="accordion">
    <div class="accordion-image">
      <img
        ...
        class="accordion-image-content"
      />
    </div>
    <div class="accordion-content">
      <p>
        <span class="accordion-content-date"> {{ experience.date }}</span
        ><br />
        <span class="accordion-content-institution"
          >{{ experience.institution }}
        </span>
      </p>
      <h2 class="accordion-content-title" v-on:click="openAccordion(id)">
        {{ experience.title }} <span class="arrow" :id="'arrow-' + id">▹</span>
      </h2>
      <p class="accordion-content-text" :id="'accordion-text-' + id">
